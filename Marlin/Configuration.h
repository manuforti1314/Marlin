...
#define STRING_CONFIG_H_AUTHOR "(IM, AM8 Take 2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AM8 SKR v1.3"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  41.79
    #define DEFAULT_Ki   7.16
    #define DEFAULT_Kd  60.98
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 208.80
  #define DEFAULT_bedKi  25.52
  #define DEFAULT_bedKd 1139.07
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34, 0, -1.75 }
